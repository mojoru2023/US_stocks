...
sql_Nas_Mons = 'select * from sp_Mons2  ; '
...
def savedt():
    ...
    excelFile3 = '{0}/{1}.xlsx'.format(ln, "sp_Mons2")  # 处理了文件属于当前目录下！
...
def sendmail():
    ...
    try:
        ...
        xlsxpart3 = MIMEApplication(open('{0}/sp_Mons2.xlsx'.format(ln), 'rb').read())
        xlsxpart3.add_header('Content-Disposition', 'attachment', filename='sp_Mons2.xlsx')
