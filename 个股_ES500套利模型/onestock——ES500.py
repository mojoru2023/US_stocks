...
index_Future_N = int(floor(index_Cash/6380))#向下取整
index_cost = 2650
stock_cost = 160

# 2019.1.22 苹果——————标普500指数模型测试(重新关注，有了接口)
...
def get_index_PL():
    try :
        ...
        for item in items:
            indexF_PL = (index_cost-item)* 50 *index_Future_N # 每点50美元 #之前的盈亏都没有加上手数？
...
# 苹果
def get_stocks_PL():
    url = 'https://www.laohu8.com/hq/s/aapl'
