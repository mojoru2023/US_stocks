...
def insertDB(content):
    ...
    try:
        ...
        f_10 = "%s," *10
        cursor.executemany('insert into us_top10_0701 ({0},top10_ave) values ({1},%s)'.format(US_top10_DB,f_10[:-1]), content)
        connection.commit()
        connection.commit()
        connection.close()
        print('向MySQL中添加数据成功！')
...
if __name__ == '__main__':
    ...
    US_top10_WEB ='TSLA,TWTR,BIDU,NVDA,CMG,AMD,SWKS,KMX,HOLX,NRG'

    US_top10_DB ='TSLA,TWTR,BIDU,NVDA,CMG,AMD,SWKS,KMX,HOLX,NRG'
 ...
 # create table us_top10_0701(id int not null primary key auto_increment, TSLA FLOAT,TWTR FLOAT,BIDU FLOAT,NVDA FLOAT,CMG FLOAT,AMD FLOAT,SWKS FLOAT,KMX FLOAT,HOLX FLOAT,NRG FLOAT, top10_ave FLOAT, LastTime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP) engine=InnoDB  charset=utf8;
