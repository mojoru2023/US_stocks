...
def savedt():
    ...
    excelFile3 = '{0}/{1}.xlsx'.format(ln, "ZGG_")  # 处理了文件属于当前目录下！
...
def sendmail():
    ...
    try:
        ...
        xlsxpart3 = MIMEApplication(open('{0}/ZGG_.xlsx'.format(ln), 'rb').read())
        xlsxpart3.add_header('Content-Disposition', 'attachment', filename='ZGG_.xlsx')
