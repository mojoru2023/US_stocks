...
sql_Nas_Mons = 'select * from nas_Mons  ; '
...
def savedt():
    ...
    excelFile3 = '{0}/{1}.xlsx'.format(ln, "Nas_Mons")  # 处理了文件属于当前目录下！
...
def sendmail():
    ...
    try:
        ...
        xlsxpart3 = MIMEApplication(open('{0}/Nas_Mons.xlsx'.format(ln), 'rb').read())
        xlsxpart3.add_header('Content-Disposition', 'attachment', filename='Nas_Mons.xlsx')
